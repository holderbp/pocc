...
\include{chapter_03_energy-and-equilibrium}
...
\include{chapter_04_EM-blackbody-radiation}
...
\include{chapter_05_heating-by-radiation}
...
\include{chapter_07_boiling-water}
...
\include{chapter_08_evaporation-and-clouds}
...
\include{chapter_09_absorption-by-greenhouse}
...
\include{chapter_10_modeling-climate}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                        Week 13  ---  Oceans and Ice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\include{chapter_11_oceans-ice}
