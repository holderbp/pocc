...
%\showsubtitlesfalse   % turn them off from this point on
\ChapterWithSubtitle{Global Average Temperature}{The anomaly is never abnormal. It's not even anomalous.}
%\showsubtitlestrue    % turn them on again
...
\includegraphics[width=\textwidth]{images/02_dessler_amarillo-vs-houston_fig2-1_no-caption.jpg}
\end{center}
%
Use the similar graph below, for two Michigan cities.  (i) Determine a reference time period (ii) Estimate the refernece temperature for each (iii) Make an anomaly temperature scale at right, and plot the values at three years for each city.
%
\begin{center}
\includegraphics[width=\textwidth]{images/02_detroit-houghton_temperatures.png}
\end{center}
%
