...
\begin{center}
\includegraphics[width=0.8\textwidth]{images/calendar-2026}
\end{center}
...
\begin{frame}{What is Physics???}
      ...
      \onslide<3>\includegraphics[width=1.1\textwidth]{images/xkcd-purity-w-philosophers}
      \end{overprint}
...
\begin{frame}{What is Physics: Sub-disciplines}
      ...
      \onslide<2>\includegraphics[width=\textwidth]{images/map-of-physics-walliman_w-climate-overlay}
      \end{overprint}
